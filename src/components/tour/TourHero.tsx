        ...
        <div
          className={
            tour.jointlyOrganized
              ? "lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(0,20rem)] lg:items-start lg:gap-x-6 xl:grid-cols-[minmax(0,1fr)_22rem] xl:gap-x-10"
              : undefined
          }
        >
          <div className="min-w-0">
            ...
            <TextReveal
              ...
              as="h1"
              delay={0.2}
              className="max-w-3xl font-heading text-2xl font-bold leading-[1.1] text-white sm:text-3xl md:text-4xl lg:text-5xl"
            />
            ...
            {tour.jointlyOrganized && (
              ...
              >
                <div className="rounded-2xl border border-white/20 bg-black/35 p-5 shadow-2xl shadow-black/30 backdrop-blur-xl">
                  <OrganizerPartners variant="feature" theme="light" showDescription />
                </div>
              </motion.div>
            )}
            ...
            <motion.div
              ...
              className="mt-6 grid max-w-xl grid-cols-2 gap-2 sm:gap-3"
            >
              {[
          ...
          {tour.jointlyOrganized && (
            <motion.aside
              ...
              className="hidden min-w-0 lg:block lg:pt-12"
              aria-label="Tour organizers"
            >
              <div className="rounded-2xl border border-white/20 bg-black/35 p-5 shadow-2xl shadow-black/30 backdrop-blur-xl sm:rounded-3xl sm:p-6">
                <OrganizerPartners variant="feature" theme="light" showDescription />
              </div>
            </motion.aside>
          )}
